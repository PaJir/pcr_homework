...
function IconSelect(_$_$elementID, _$_$parameters) {
    ...
    this.refresh = function(_$icons){
        ...
        for(var i = 0; i < _$icons.length; i++){
            _$icons[i].element = _View.createIcon(_$icons[i].iconFilePath, _$icons[i].iconValue, i, _$_$parameters);
    ...
    _View.createIcon = function(_$iconFilePath, _$iconValue, _$index, _$parameters){
